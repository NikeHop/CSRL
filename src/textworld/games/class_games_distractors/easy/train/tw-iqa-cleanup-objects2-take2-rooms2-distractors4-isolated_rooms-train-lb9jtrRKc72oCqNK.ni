...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a kitchen cupboard.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1], so there's that.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " dishwasher.[if c_3 is open and there is something in the c_3] The dishwasher contains [a list of things in the c_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if c_3 is open and the c_3 contains nothing] The dishwasher is empty! What a waste of a day![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a trash can.[if c_5 is open and there is something in the c_5] The trash can contains [a list of things in the c_5].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if c_5 is open and the c_5 contains nothing] The trash can is empty, what a horrible day![end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " You make out a dining table. Now why would someone leave that there? [if there is something on the s_0]On the dining table you can make out [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of trash.[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is " You make out a shelf. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "[if there is nothing on the s_3]But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is " glass door leading west.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2]. Hmmm... what else, what else?[end if]".
The bedroom part 2 is some text that varies. The bedroom part 2 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The wardrobe is empty![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " bookcase.[if c_4 is open and there is something in the c_4] The bookcase contains [a list of things in the c_4].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if c_4 is open and the c_4 contains nothing] What a letdown! The bookcase is empty![end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a bed. Wow, isn't TextWorld just the best? [if there is something on the s_1]On the bed you can see [a list of things on the s_1].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. Hm. Oh well[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is " You rest your hand against a wall, but you miss the wall and fall onto a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa. Wow! Just like in the movies![end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is " glass door leading east.".
The description of r_1 is "[bedroom part 0][bedroom part 1][bedroom part 2][bedroom part 3][bedroom part 4][bedroom part 5][bedroom part 6][bedroom part 7][bedroom part 8][bedroom part 9][bedroom part 10][bedroom part 11]".
...
The o_1 and the o_2 and the o_3 and the o_0 and the o_4 and the o_5 are object-likes.
The o_1 and the o_2 and the o_3 and the o_0 and the o_4 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
...
The c_4 is in r_1.
The c_4 is open.
The description of c_5 is "The [noun] looks rugged. [if open]It is open.[else if locked]It is locked.[otherwise]It is closed.[end if]".
...
The printed name of o_1 is "yoghurt".
Understand "yoghurt" as o_1.
...
The printed name of o_0 is "jam".
Understand "jam" as o_0.
...
The printed name of o_5 is "teddy".
Understand "teddy" as o_5.
