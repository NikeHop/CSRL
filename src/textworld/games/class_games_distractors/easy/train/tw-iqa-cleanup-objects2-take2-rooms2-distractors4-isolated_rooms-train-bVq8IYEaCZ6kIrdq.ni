...
The kitchen part 6 is some text that varies. The kitchen part 6 is " cutlery drawer.[if c_3 is open and there is something in the c_3] The cutlery drawer contains [a list of things in the c_3].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a fruit basket.[if c_4 is open and there is something in the c_4] The fruit basket contains [a list of things in the c_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if c_4 is open and the c_4 contains nothing] The fruit basket is empty, what a horrible day![end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " You make out a dining table. [if there is something on the s_0]On the dining table you can make out [a list of things on the s_0].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_0]But the thing is empty, unfortunately.[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is " You bend down to tie your shoe. When you stand up, you notice a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "[if there is nothing on the s_2]However, the sofa, like an empty sofa, has nothing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is " You smell an interesting smell, and follow it to a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can see [a list of things on the s_3].[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "[if there is nothing on the s_3] However, the shelf, like an empty shelf, has nothing on it. Hm. Oh well[end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 17 is some text that varies. The kitchen part 17 is " glass door leading north.".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Look out! It's a- oh, never mind, it's just a bed. The bed is large.[if there is something on the s_1] On the bed you can make out [a list of things on the s_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] But there isn't a thing on it. Hm. Oh well[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a desk chair. The desk chair is normal.[if there is something on the s_4] On the desk chair you can see [a list of things on the s_4]. You shudder, but continue examining the room.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4] But the thing is empty, unfortunately.[end if]".
...
The c_3 is in r_0.
The c_3 is open.
The description of c_4 is "The [noun] looks stuffy. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to break open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
The printed name of c_4 is "fruit basket".
Understand "fruit basket" as c_4.
Understand "fruit" as c_4.
