...
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a desk chair. [if there is something on the s_4]You see [a list of things on the s_4] on the desk chair.[end if]".
