...
The kitchen part 11 is some text that varies. The kitchen part 11 is " glass door leading south.".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a table. [if there is something on the s_4]On the table you can make out [a list of things on the s_4].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_4]But there isn't a thing on it.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " What's that over there? It looks like it's a desk chair. The desk chair is normal.[if there is something on the s_5] On the desk chair you make out [a list of things on the s_5].[end if]".
...
The o_3 and the o_0 and the o_1 and the o_2 and the o_4 and the o_5 are object-likes.
The o_3 and the o_0 and the o_1 and the o_2 and the o_4 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
