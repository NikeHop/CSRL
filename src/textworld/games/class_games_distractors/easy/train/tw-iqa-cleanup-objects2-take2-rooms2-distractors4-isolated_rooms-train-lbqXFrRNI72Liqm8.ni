...
The kitchen part 6 is some text that varies. The kitchen part 6 is " oven nearby.[if c_3 is open and there is something in the c_3] The oven contains [a list of things in the c_3]. Hmmm... what else, what else?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if c_3 is open and the c_3 contains nothing] The oven is empty! What a waste of a day![end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a bed. The bed is large.[if there is something on the s_1] On the bed you make out [a list of things on the s_1].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the bed.[end if]".
