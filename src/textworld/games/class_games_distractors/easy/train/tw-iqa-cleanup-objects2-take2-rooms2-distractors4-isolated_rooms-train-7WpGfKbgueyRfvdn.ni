...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room for a wall, and you find a wall. The wall is white.[if there is something on the s_4] On the wall you see [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of junk.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You see a TV stand. [if there is something on the s_5]On the TV stand you can see [a list of things on the s_5].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_5]The TV stand appears to be empty.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " kitchen cupboard.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1]. A kitchen cupboard... Is that really what you were looking for?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you can see [a list of things on the s_0].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_0] However, the dining table, like an empty dining table, has nothing on it.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you see [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " As if things weren't amazing enough already, you can even see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_3] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the shelf.[end if]".
