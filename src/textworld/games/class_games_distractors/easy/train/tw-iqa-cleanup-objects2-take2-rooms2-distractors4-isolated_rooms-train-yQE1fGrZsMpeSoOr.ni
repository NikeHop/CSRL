...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a stove. You wonder idly who left that here. [if there is something on the s_4]You see [a list of things on the s_4] on the stove.[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Oh, great. Here's a shoe cabinet. Now why would someone leave that there?[if c_3 is open and there is something in the c_3] The shoe cabinet contains [a list of things in the c_3].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Hey, want to see a bed? Look over there, a bed. [if there is something on the s_1]On the bed you make out [a list of things on the s_1].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you make out [a list of things on the s_2].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_2] But the thing is empty, unfortunately. Hm. Oh well[end if]".
