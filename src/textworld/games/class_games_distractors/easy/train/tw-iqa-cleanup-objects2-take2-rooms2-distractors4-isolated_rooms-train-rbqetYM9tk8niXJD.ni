...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can see [a list of things on the s_2]. You shudder, but continue examining the room.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it. This always happens![end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You smell a wretched smell, and follow it to a wall. The wall is white.[if there is something on the s_4] On the wall you can see [a list of things on the s_4].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of trash.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is " You see a TV stand. You wonder idly who left that here. [if there is something on the s_5]You see [a list of things on the s_5] on the TV stand.[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of trash. Hm. Oh well[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " kitchen cupboard.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " oven.[if c_3 is open and there is something in the c_3] The oven contains [a list of things in the c_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The oven is empty![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " What's that over there? It looks like it's a dining table. Wow, isn't TextWorld just the best? [if there is something on the s_0]On the dining table you can see [a list of things on the s_0].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_0]But the thing is empty, unfortunately. Hm. Oh well[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " You rest your hand against a wall, but you miss the wall and fall onto a shelf. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf. Wow! Just like in the movies![end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_3]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The printed name of o_1 is "olive".
Understand "olive" as o_1.
