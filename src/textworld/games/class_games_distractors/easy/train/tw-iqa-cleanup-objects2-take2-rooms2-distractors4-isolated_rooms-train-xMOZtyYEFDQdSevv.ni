...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room for a table, and you find a table. The table is vast.[if there is something on the s_4] On the table you see [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You see a wall. [if there is something on the s_5]On the wall you can see [a list of things on the s_5].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_5]The wall appears to be empty.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " kitchen cupboard, which looks conventional, in the corner.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you can see [a list of things on the s_0].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0] The dining table appears to be empty. It would have been so cool if there was stuff on the dining table.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a sofa. [if there is something on the s_2]On the sofa you can see [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the sofa.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a shelf. You wonder idly who left that here. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3] The shelf appears to be empty.[end if]".
...
The o_0 and the o_1 and the o_4 and the o_2 and the o_3 and the o_5 are object-likes.
The o_0 and the o_1 and the o_4 and the o_2 and the o_3 and the o_5 are privately-named.
The r_1 and the r_0 are rooms.
