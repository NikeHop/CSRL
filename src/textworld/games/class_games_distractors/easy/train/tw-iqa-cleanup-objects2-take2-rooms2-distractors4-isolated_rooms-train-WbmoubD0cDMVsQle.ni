...
The kitchen part 10 is some text that varies. The kitchen part 10 is " Look out! It's a- oh, never mind, it's just a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is " You can see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "[if there is nothing on the s_3] However, the shelf, like an empty shelf, has nothing on it. It would have been so cool if there was stuff on the shelf! oh well.[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is " You can see a table. [if there is something on the s_4]You see [a list of things on the s_4] on the table.[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "[if there is nothing on the s_4]However, the table, like an empty table, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is " Hey, want to see a ladderback chair? Look over there, a ladderback chair. The ladderback chair is solid.[if there is something on the s_5] On the ladderback chair you see [a list of things on the s_5].[end if]".
The kitchen part 17 is some text that varies. The kitchen part 17 is "[if there is nothing on the s_5] However, the ladderback chair, like an empty ladderback chair, has nothing on it.[end if]".
The kitchen part 18 is some text that varies. The kitchen part 18 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 19 is some text that varies. The kitchen part 19 is " plain door leading west.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe in the corner.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out a bed. [if there is something on the s_1]On the bed you can make out [a list of things on the s_1].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if there is nothing on the s_1]But there isn't a thing on it.[end if]".
...
The o_1 and the o_2 and the o_4 and the o_0 and the o_3 and the o_5 are object-likes.
The o_1 and the o_2 and the o_4 and the o_0 and the o_3 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
...
The printed name of o_0 is "noodles".
Understand "noodles" as o_0.
