...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've fallen into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the kitchen.
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a counter. The counter is vast.[if there is something on the s_4] On the counter you see [a list of things on the s_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of junk. It would have been so cool if there was stuff on the counter.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " plain door leading north.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A standard kind of place. You start to take note of what's in the room.

 You can see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe, which looks large, nearby.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You smell a pungent smell, and follow it to a bed. I guess it's true what they say, if you're looking for a bed, go to TextWorld. [if there is something on the s_1]On the bed you make out [a list of things on the s_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a sofa. [if there is something on the s_2]On the sofa you can make out [a list of things on the s_2].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_2]But there isn't a thing on it.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " What's that over there? It looks like it's a TV stand. The TV stand is normal.[if there is something on the s_5] On the TV stand you make out [a list of things on the s_5].[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_5] But the thing is empty, unfortunately. Hm. Oh well[end if]".
...
The o_0 and the o_1 and the o_2 and the o_5 and the o_3 and the o_4 are object-likes.
The o_0 and the o_1 and the o_2 and the o_5 and the o_3 and the o_4 are privately-named.
The r_0 and the r_1 are rooms.
