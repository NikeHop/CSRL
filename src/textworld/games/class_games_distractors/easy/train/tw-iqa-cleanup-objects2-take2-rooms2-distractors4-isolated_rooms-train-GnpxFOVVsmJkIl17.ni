...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You can make out a desk chair. [if there is something on the s_4]You see [a list of things on the s_4] on the desk chair.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_4]But the thing is empty, unfortunately. What's the point of an empty desk chair?[end if]".
