...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] The shelf appears to be empty. It would have been so cool if there was stuff on the shelf! oh well.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You make out a floor. [if there is something on the s_4]You see [a list of things on the s_4] on the floor.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. This always happens![end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You make out a bookcase.[if c_3 is open and there is something in the c_3] The bookcase contains [a list of things in the c_3]. You look at the price tag on the bookcase. Sixty dollars?! Where'd they buy this bookcase, some kind of expensive place?[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The bookcase is empty![end if]".
...
The bedroom part 8 is some text that varies. The bedroom part 8 is " You make out a TV stand. [if there is something on the s_5]On the TV stand you can see [a list of things on the s_5].[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of trash. Aw, here you were, all excited for there to be things on it![end if]".
...
The printed name of o_4 is "television".
Understand "television" as o_4.
