...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You can make out a bed. [if there is something on the s_1]You see [a list of things on the s_1] on the bed.[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. Aw, here you were, all excited for there to be things on it![end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a desk chair. The desk chair is ordinary.[if there is something on the s_4] On the desk chair you can see [a list of things on the s_4]. You shudder, but continue examining the room.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. This always happens![end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You scan the room, seeing a cutlery drawer.[if c_3 is open and there is something in the c_3] The cutlery drawer contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The cutlery drawer is empty, what a horrible day![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell an awful smell, and follow it to a dining table. [if there is something on the s_0]On the dining table you can see [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You make out a sofa. Now why would someone leave that there? The sofa is comfy.[if there is something on the s_2] On the sofa you see [a list of things on the s_2].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You rest your hand against a wall, but you miss the wall and fall onto a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_3] Looks like someone's already been here and taken everything off it, though. You move on, clearly angry about your TextWorld experience.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is " You see a ladderback chair. [if there is something on the s_5]You see [a list of things on the s_5] on the ladderback chair. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is "[if there is nothing on the s_5]Unfortunately, there isn't a thing on it. You think about smashing the ladderback chair to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is " plain door leading east.".
...
The printed name of s_5 is "ladderback chair".
Understand "ladderback chair" as s_5.
Understand "ladderback" as s_5.
...
The printed name of o_4 is "corkscrew".
Understand "corkscrew" as o_4.
...
The printed name of o_0 is "chocolate".
Understand "chocolate" as o_0.
