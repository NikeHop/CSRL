...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're not going to believe this, but you've just entered a bedroom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You scan the room for a sofa, and you find a sofa. [if there is something on the s_2]On the sofa you make out [a list of things on the s_2].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of junk.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " You can make out a nightstand. [if there is something on the s_4]You see [a list of things on the s_4] on the nightstand.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_4]But the thing is empty, unfortunately. What's the point of an empty nightstand?[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You scan the room, seeing a trash can.[if c_3 is open and there is something in the c_3] The trash can contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The trash can is empty, what a horrible day![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look over there! a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you see [a list of things on the s_0].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_0] The dining table appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " Oh, great. Here's a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you make out [a list of things on the s_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " You can make out a dining chair. [if there is something on the s_5]On the dining chair you see [a list of things on the s_5]. Hmmm... what else, what else?[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of garbage.[end if]".
