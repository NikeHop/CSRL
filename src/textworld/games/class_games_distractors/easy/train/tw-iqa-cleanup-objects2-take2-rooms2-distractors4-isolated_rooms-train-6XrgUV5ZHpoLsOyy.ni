...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a dark carpet. [if there is something on the s_4]You see [a list of things on the s_4] on the dark carpet.[end if]".
