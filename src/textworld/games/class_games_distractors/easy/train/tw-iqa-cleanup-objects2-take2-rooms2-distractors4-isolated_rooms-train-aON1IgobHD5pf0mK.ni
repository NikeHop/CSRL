...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a wall. The wall is white.[if there is something on the s_4] On the wall you can see [a list of things on the s_4].[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " plain door leading west.".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You can see a dressing table. The dressing table is normal.[if there is something on the s_5] On the dressing table you see [a list of things on the s_5].[end if]".
