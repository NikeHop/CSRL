...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a trash can.[if c_3 is open and there is something in the c_3] The trash can contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The trash can is empty! What a waste of a day![end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a shelf. [if there is something on the s_3]On the shelf you see [a list of things on the s_3].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]The shelf appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is " plain door leading south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual one.
 ...
 You bend down to tie your shoe. When you stand up, you notice a wardrobe.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Look over there! a bed. The bed is large.[if there is something on the s_1] On the bed you see [a list of things on the s_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] The bed appears to be empty. It would have been so cool if there was stuff on the bed.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2]However, the sofa, like an empty sofa, has nothing on it.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a wall. The wall is white.[if there is something on the s_4] On the wall you see [a list of things on the s_4]. It doesn't get more TextWorld than this![end if]".
...
The bedroom part 8 is some text that varies. The bedroom part 8 is " You make out a desk. [if there is something on the s_5]On the desk you make out [a list of things on the s_5].[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_5]However, the desk, like an empty desk, has nothing on it.[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is " plain door leading north.".
...
The o_0 and the o_4 and the o_5 and the o_1 and the o_2 and the o_3 are object-likes.
The o_0 and the o_4 and the o_5 and the o_1 and the o_2 and the o_3 are privately-named.
The r_0 and the r_1 are rooms.
...
The printed name of o_0 is "belt".
