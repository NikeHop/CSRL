...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a dining chair. The dining chair is solid.[if there is something on the s_4] On the dining chair you can see [a list of things on the s_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_4] However, the dining chair, like an empty dining chair, has nothing on it. You move on, clearly depressed by TextWorld.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " plain door leading south.".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out a chest of drawers.[if c_3 is open and there is something in the c_3] The chest of drawers contains [a list of things in the c_3].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_3 is open and the c_3 contains nothing] The chest of drawers is empty! This is the worst thing that could possibly happen, ever![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " You scan the room, seeing a bed. The bed is large.[if there is something on the s_1] On the bed you see [a list of things on the s_1].[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You see a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_2]But the thing is empty, unfortunately.[end if]".
