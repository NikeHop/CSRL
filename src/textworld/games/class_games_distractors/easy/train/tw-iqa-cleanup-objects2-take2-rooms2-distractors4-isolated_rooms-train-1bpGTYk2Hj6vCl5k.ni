...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Oh, great. Here's a table. Wow, isn't TextWorld just the best? The table is vast.[if there is something on the s_4] On the table you can see [a list of things on the s_4].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4] However, the table, like an empty table, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " Look out! It's a- oh, never mind, it's just a desk. [if there is something on the s_5]On the desk you make out [a list of things on the s_5]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bedroom part 8 is some text that varies. The bedroom part 8 is " You can make out a nightstand. [if there is something on the s_6]On the nightstand you see [a list of things on the s_6].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look over there! a sofa. [if there is something on the s_2]On the sofa you see [a list of things on the s_2].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it. Hm. Oh well[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can make out [a list of things on the s_3].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3] But the thing hasn't got anything on it.[end if]".
