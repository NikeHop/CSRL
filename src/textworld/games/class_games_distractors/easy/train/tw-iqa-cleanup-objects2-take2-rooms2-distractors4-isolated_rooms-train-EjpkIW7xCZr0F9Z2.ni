...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You scan the room, seeing a fruit basket.[if c_3 is open and there is something in the c_3] The fruit basket contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The fruit basket is empty, what a horrible day![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a dining table. [if there is something on the s_0]You see [a list of things on the s_0] on the dining table.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You make out a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3]. It doesn't get more TextWorld than this![end if]".
