...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room for a wall, and you find a wall. The wall is white.[if there is something on the s_4] On the wall you can make out [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. You move on, clearly angry about your TextWorld experience.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " Oh, great. Here's a dressing table. The dressing table is normal.[if there is something on the s_5] On the dressing table you can see [a list of things on the s_5]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bedroom part 9 is some text that varies. The bedroom part 9 is " glass door leading west.".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you see [a list of things on the s_0].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can make out [a list of things on the s_2].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_2] The sofa appears to be empty.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can see [a list of things on the s_3].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_3] However, the shelf, like an empty shelf, has nothing on it.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " You see a floor. [if there is something on the s_6]You see [a list of things on the s_6] on the floor. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_6]Unfortunately, there isn't a thing on it. You think about smashing the floor to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
