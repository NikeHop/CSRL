...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a dark carpet. The dark carpet is standard.[if there is something on the s_4] On the dark carpet you can see [a list of things on the s_4].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_4] However, the dark carpet, like an empty dark carpet, has nothing on it.[end if]".
...
The printed name of o_5 is "floor lamp".
Understand "floor lamp" as o_5.
Understand "floor" as o_5.
