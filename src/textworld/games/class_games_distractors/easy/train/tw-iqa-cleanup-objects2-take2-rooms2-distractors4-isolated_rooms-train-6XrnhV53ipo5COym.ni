...
The bedroom part 6 is some text that varies. The bedroom part 6 is " Oh, great. Here's a nightstand. The nightstand is normal.[if there is something on the s_5] On the nightstand you can see [a list of things on the s_5]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " glass door leading east.".
...
The printed name of o_0 is "rice".
Understand "rice" as o_0.
