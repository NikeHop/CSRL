...
The bedroom part 3 is some text that varies. The bedroom part 3 is " shoe cabinet in the room.[if c_3 is open and there is something in the c_3] The shoe cabinet contains [a list of things in the c_3].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_3 is open and the c_3 contains nothing] The shoe cabinet is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1] The bed appears to be empty.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " You see a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can make out [a list of things on the s_2].[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_2] The sofa appears to be empty. It would have been so cool if there was stuff on the sofa! oh well.[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " You make out a desk. [if there is something on the s_5]You see [a list of things on the s_5] on the desk.[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "[if there is nothing on the s_5]But the thing hasn't got anything on it. This always happens![end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 12 is some text that varies. The bedroom part 12 is " glass door leading west.".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " kitchen cupboard in the room.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1]. Does this look like anything mentioned in the instructions?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You scan the room, seeing a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you see [a list of things on the s_0].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_0] However, the dining table, like an empty dining table, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a shelf. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_3]But the thing is empty, unfortunately.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " Were you looking for a dining chair? Because look over there, it's a dining chair. The dining chair is solid.[if there is something on the s_4] On the dining chair you make out [a list of things on the s_4], so there's that.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_4] But the thing hasn't got anything on it.[end if]".
...
The printed name of o_1 is "corn".
Understand "corn" as o_1.
...
The printed name of o_4 is "radio".
Understand "radio" as o_4.
