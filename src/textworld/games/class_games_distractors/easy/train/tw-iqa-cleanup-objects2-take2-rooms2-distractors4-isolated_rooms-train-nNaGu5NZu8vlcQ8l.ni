...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a floor. The floor is vast.[if there is something on the s_4] On the floor you can see [a list of things on the s_4].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " Look over there! a bed. [if there is something on the s_1]You see [a list of things on the s_1] on the bed. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You scan the room, seeing a sofa. [if there is something on the s_2]On the sofa you can make out [a list of things on the s_2].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_2]However, the sofa, like an empty sofa, has nothing on it.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " You can see a TV stand. The TV stand is normal.[if there is something on the s_5] On the TV stand you see [a list of things on the s_5].[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_5] Unfortunately, there isn't a thing on it.[end if]".
