...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look out! It's a- oh, never mind, it's just a sofa. [if there is something on the s_2]On the sofa you can see [a list of things on the s_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2]But the thing hasn't got anything on it.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can see [a list of things on the s_3].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3] But oh no! there's nothing on this piece of trash. This always happens, here in TextWorld![end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " If you haven't noticed it already, there seems to be something there by the wall, it's a floor. The floor is vast.[if there is something on the s_4] On the floor you can make out [a list of things on the s_4].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of garbage. This always happens![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You make out a desk. [if there is something on the s_5]On the desk you make out [a list of things on the s_5].[end if]".
