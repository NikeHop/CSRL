...
The kitchen part 12 is some text that varies. The kitchen part 12 is " You can see a table. The table is vast.[if there is something on the s_4] On the table you see [a list of things on the s_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "[if there is nothing on the s_4] However, the table, like an empty table, has nothing on it. It would have been so cool if there was stuff on the table! oh well.[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is " You can see a counter. [if there is something on the s_5]You see [a list of things on the s_5] on the counter.[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "[if there is nothing on the s_5]However, the counter, like an empty counter, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You make out a sofa. [if there is something on the s_2]On the sofa you can make out [a list of things on the s_2].[end if]".
...
The printed name of o_3 is "spatula".
Understand "spatula" as o_3.
