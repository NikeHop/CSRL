...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Look over there! a bed. [if there is something on the s_1]On the bed you make out [a list of things on the s_1]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " glass door leading west.".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An ordinary kind of place.
 ...
 Look out! It's a- oh, never mind, it's just a fridge. Classic TextWorld.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " kitchen cupboard right there by you.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you can make out [a list of things on the s_0].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0] The dining table appears to be empty. This always happens![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look over there! a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You scan the room, seeing a shelf. [if there is something on the s_3]On the shelf you can make out [a list of things on the s_3].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]However, the shelf, like an empty shelf, has nothing on it.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You can see a ladderback chair. The ladderback chair is solid.[if there is something on the s_4] On the ladderback chair you see [a list of things on the s_4].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a table. You wonder idly who left that here. [if there is something on the s_5]You see [a list of things on the s_5] on the table.[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is "[if there is nothing on the s_5]Looks like someone's already been here and taken everything off it, though. You think about smashing the table to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is " glass door leading east.".
...
The printed name of o_3 is "candle".
Understand "candle" as o_3.
