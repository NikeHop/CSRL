...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You scan the room, seeing a stove. The stove is conventional.[if there is something on the s_6] On the stove you can make out [a list of things on the s_6]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_6] However, the stove, like an empty stove, has nothing on it. Hm. Oh well[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Hey, want to see a wall? Look over there, a wall. [if there is something on the s_4]On the wall you make out [a list of things on the s_4].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4]The wall appears to be empty.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a nightstand. [if there is something on the s_5]On the nightstand you make out [a list of things on the s_5].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_5]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the nightstand.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " glass door leading north.".
