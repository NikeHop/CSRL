...
The kitchen part 5 is some text that varies. The kitchen part 5 is " Hey, want to see an oven? Look over there, an oven. Hmmm... what else, what else?[if c_3 is open and there is something in the c_3] The oven contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The oven is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You make out a bed. The bed is large.[if there is something on the s_1] On the bed you can see [a list of things on the s_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] However, the bed, like an empty bed, has nothing on it.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room, seeing a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you see [a list of things on the s_2].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2] But the thing is empty. Hm. Oh well[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You see a desk. [if there is something on the s_4]You see [a list of things on the s_4] on the desk.[end if]".
...
The bedroom part 8 is some text that varies. The bedroom part 8 is " You scan the room for a nightstand, and you find a nightstand. [if there is something on the s_5]On the nightstand you see [a list of things on the s_5].[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_5]The nightstand appears to be empty.[end if]".
...
The o_0 and the o_1 and the o_3 and the o_4 and the o_2 and the o_5 are object-likes.
The o_0 and the o_1 and the o_3 and the o_4 and the o_2 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
