...
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading west.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Look at that sign! What does it say? It says Welcome to the bedroom? Well that's cool.

 Were you looking for a wardrobe? Because look over there, it's a wardrobe.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2], so there's that.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " shoe cabinet in the room.[if c_4 is open and there is something in the c_4] The shoe cabinet contains [a list of things in the c_4].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_4 is open and the c_4 contains nothing] What a letdown! The shoe cabinet is empty![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a bed. The bed is large.[if there is something on the s_1] On the bed you make out [a list of things on the s_1].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The c_3 is in r_0.
The c_3 is open.
The description of c_4 is "The [noun] looks rugged. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
