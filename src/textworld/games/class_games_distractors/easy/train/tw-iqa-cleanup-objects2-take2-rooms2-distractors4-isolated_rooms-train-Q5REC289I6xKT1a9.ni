...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out an oven.[if c_3 is open and there is something in the c_3] The oven contains [a list of things in the c_3].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if c_3 is open and the c_3 contains nothing] The oven is empty! What a waste of a day![end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a desk. The desk is normal.[if there is something on the s_4] On the desk you see [a list of things on the s_4]. It doesn't get more TextWorld than this![end if]".
