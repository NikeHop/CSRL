...
The kitchen part 17 is some text that varies. The kitchen part 17 is " plain door leading north.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've moved into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bedroom.
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " What's that over there? It looks like it's a bed. The bed is large.[if there is something on the s_1] On the bed you make out [a list of things on the s_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the bed.[end if]".
...
The printed name of o_2 is "candle".
Understand "candle" as o_2.
...
The printed name of o_5 is "table lamp".
Understand "table lamp" as o_5.
