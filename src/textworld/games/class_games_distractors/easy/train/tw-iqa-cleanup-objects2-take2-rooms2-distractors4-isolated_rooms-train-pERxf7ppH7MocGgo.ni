...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a stove. The stove is conventional.[if there is something on the s_4] On the stove you see [a list of things on the s_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of junk. It would have been so cool if there was stuff on the stove.[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " What's that over there? It looks like it's a nightstand. The nightstand is normal.[if there is something on the s_5] On the nightstand you make out [a list of things on the s_5].[end if]".
...
The description of o_3 is "The [noun] appears to be to fit in here".
The printed name of o_3 is "radio".
Understand "radio" as o_3.
