...
The kitchen part 14 is some text that varies. The kitchen part 14 is " You can see a ladderback chair. [if there is something on the s_5]You see [a list of things on the s_5] on the ladderback chair.[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "[if there is nothing on the s_5]However, the ladderback chair, like an empty ladderback chair, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You make out a desk. [if there is something on the s_4]On the desk you can make out [a list of things on the s_4].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_4]But there isn't a thing on it.[end if]".
