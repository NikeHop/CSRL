...
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading north.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in a bedroom.
 ...
 You scan the room for a wardrobe, and you find a wardrobe. The light flickers for a second, but nothing else happens.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You make out a bed. [if there is something on the s_1]You see [a list of things on the s_1] on the bed. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Hey, want to see a desk? Look over there, a desk. [if there is something on the s_5]On the desk you make out [a list of things on the s_5].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_5]The desk appears to be empty.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a desk chair. The desk chair is normal.[if there is something on the s_6] On the desk chair you make out [a list of things on the s_6].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_6] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the desk chair.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " plain door leading south.".
...
The printed name of s_6 is "desk chair".
Understand "desk chair" as s_6.
