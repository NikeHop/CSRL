...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see a bed. The bed is large.[if there is something on the s_1] On the bed you see [a list of things on the s_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] But there isn't a thing on it.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can make out [a list of things on the s_2].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2] The sofa appears to be empty.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a coat hanger. The coat hanger is standard.[if there is something on the s_4] On the coat hanger you can see [a list of things on the s_4].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_4] However, the coat hanger, like an empty coat hanger, has nothing on it.[end if]".
...
The o_1 and the o_3 and the o_4 and the o_0 and the o_2 and the o_5 are object-likes.
The o_1 and the o_3 and the o_4 and the o_0 and the o_2 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
