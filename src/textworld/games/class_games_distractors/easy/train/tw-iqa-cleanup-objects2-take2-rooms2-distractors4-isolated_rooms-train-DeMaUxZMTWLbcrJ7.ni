...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see [if c_4 is locked]a locked[else if c_4 is open]an opened[otherwise]a closed[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is " shoe cabinet.[if c_4 is open and there is something in the c_4] The shoe cabinet contains [a list of things in the c_4]. Hmmm... what else, what else?[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You hear a noise behind you and spin around, but you can't see anything other than a bed. [if there is something on the s_1]On the bed you make out [a list of things on the s_1].[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You bend down to tie your shoe. When you stand up, you notice a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can see [a list of things on the s_2].[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_2] The sofa appears to be empty.[end if]".
