...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a ladderback chair. You wonder idly who left that here. [if there is something on the s_4]You see [a list of things on the s_4] on the ladderback chair.[end if]".
...
The o_5 and the o_0 and the o_1 and the o_2 and the o_3 and the o_4 are object-likes.
The o_5 and the o_0 and the o_1 and the o_2 and the o_3 and the o_4 are privately-named.
The r_0 and the r_1 are rooms.
