...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You make out a bed. The bed is large.[if there is something on the s_1] On the bed you can make out [a list of things on the s_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if there is nothing on the s_1] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the bed.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room for a sofa, and you find a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can make out [a list of things on the s_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it. You move on, clearly angry about your TextWorld experience.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " Oh, great. Here's a desk. The desk is normal.[if there is something on the s_5] On the desk you can see [a list of things on the s_5]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_5] But there isn't a thing on it.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is " You can see a dark carpet. Wow, isn't TextWorld just the best? [if there is something on the s_6]On the dark carpet you see [a list of things on the s_6].[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_6]But oh no! there's nothing on this piece of trash. It would have been so cool if there was stuff on the dark carpet.[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is " plain door leading west.".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Oh, great. Here's a kitchen cupboard. Now why would someone leave that there?[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Hey, want to see a dining table? Look over there, a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you see [a list of things on the s_0].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_0] However, the dining table, like an empty dining table, has nothing on it.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " What's that over there? It looks like it's a shelf. [if there is something on the s_3]On the shelf you can see [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]But there isn't a thing on it. What's the point of an empty shelf?[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a table. The table is vast.[if there is something on the s_4] On the table you see [a list of things on the s_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_4] However, the table, like an empty table, has nothing on it.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " plain door leading east.".
...
The printed name of s_6 is "dark carpet".
Understand "dark carpet" as s_6.
Understand "dark" as s_6.
