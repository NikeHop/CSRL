...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a table. The table is vast.[if there is something on the s_4] On the table you can see [a list of things on the s_4].[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You can see a nightstand. The nightstand is normal.[if there is something on the s_5] On the nightstand you see [a list of things on the s_5].[end if]".
