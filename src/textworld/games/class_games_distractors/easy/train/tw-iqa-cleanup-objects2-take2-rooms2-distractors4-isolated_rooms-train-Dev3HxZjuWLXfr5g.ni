...
The kitchen part 9 is some text that varies. The kitchen part 9 is " plain door leading north.".
...
The bedroom part 9 is some text that varies. The bedroom part 9 is " What's that over there? It looks like it's a dark carpet. [if there is something on the s_5]You see [a list of things on the s_5] on the dark carpet.[end if]".
...
The bedroom part 11 is some text that varies. The bedroom part 11 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 12 is some text that varies. The bedroom part 12 is " plain door leading south.".
...
The printed name of o_2 is "plant".
Understand "plant" as o_2.
