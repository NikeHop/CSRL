...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You smell a wretched smell, and follow it to a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can make out [a list of things on the s_3]. Classic TextWorld.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] However, the shelf, like an empty shelf, has nothing on it. Hopefully this doesn't make you too upset.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " glass door leading west.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe right there by you.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out a bed. The bed is large.[if there is something on the s_1] On the bed you make out [a list of things on the s_1]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if there is nothing on the s_1] But the thing is empty, unfortunately.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can see [a list of things on the s_2].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_2] But the thing hasn't got anything on it.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " Hey, want to see a table? Look over there, a table. The table is vast.[if there is something on the s_4] On the table you can make out [a list of things on the s_4].[end if]".
...
The bedroom part 9 is some text that varies. The bedroom part 9 is " What's that over there? It looks like it's a coat hanger. [if there is something on the s_5]You see [a list of things on the s_5] on the coat hanger.[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "[if there is nothing on the s_5]But the thing is empty, unfortunately. Hm. Oh well[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is " You make out a nightstand. The nightstand is typical.[if there is something on the s_6] On the nightstand you see [a list of things on the s_6].[end if]".
The bedroom part 12 is some text that varies. The bedroom part 12 is "[if there is nothing on the s_6] However, the nightstand, like an empty nightstand, has nothing on it.[end if]".
The bedroom part 13 is some text that varies. The bedroom part 13 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 14 is some text that varies. The bedroom part 14 is " glass door leading east.".
