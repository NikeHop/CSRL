...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You scan the room for a dining table, and you find a dining table. [if there is something on the s_0]You see [a list of things on the s_0] on the dining table.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell a wretched smell, and follow it to a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you can see [a list of things on the s_2].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2] But oh no! there's nothing on this piece of trash.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a shelf. You wonder idly who left that here. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of trash. Hm. Oh well[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You rest your hand against a wall, but you miss the wall and fall onto a wall. [if there is something on the s_4]On the wall you can make out [a list of things on the s_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4]However, the wall, like an empty wall, has nothing on it. It would have been so cool if there was stuff on the wall! oh well.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is " You smell an interesting smell, and follow it to a dining chair. The dining chair is solid.[if there is something on the s_5] On the dining chair you can see [a list of things on the s_5].[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is "[if there is nothing on the s_5] However, the dining chair, like an empty dining chair, has nothing on it. Hm. Oh well[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is " plain door leading south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom.
 ...
 You can make out a wardrobe.[if c_2 is open and there is something in the c_2] The wardrobe contains [a list of things in the c_2].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is " chest of drawers right there by you.[if c_3 is open and there is something in the c_3] The chest of drawers contains [a list of things in the c_3].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a bed. The bed is large.[if there is something on the s_1] On the bed you make out [a list of things on the s_1].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1] But there isn't a thing on it.[end if]".
...
The printed name of o_2 is "television".
Understand "television" as o_2.
