...
The kitchen part 6 is some text that varies. The kitchen part 6 is " dishwasher nearby.[if c_3 is open and there is something in the c_3] The dishwasher contains [a list of things in the c_3]. Hmmm... what else, what else?[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " You can see a wall. The wall is white.[if there is something on the s_4] On the wall you see [a list of things on the s_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "[if there is nothing on the s_4] However, the wall, like an empty wall, has nothing on it. It would have been so cool if there was stuff on the wall! oh well.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You hear a noise behind you and spin around, but you can't see anything other than a bed. The bed is large.[if there is something on the s_1] On the bed you can see [a list of things on the s_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You see a desk chair. [if there is something on the s_5]On the desk chair you see [a list of things on the s_5]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_5]Unfortunately, there isn't a thing on it. You think about smashing the desk chair to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
