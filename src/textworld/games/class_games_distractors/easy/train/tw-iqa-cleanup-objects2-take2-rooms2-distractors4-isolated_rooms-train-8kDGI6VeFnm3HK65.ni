...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see a bookcase.[if c_3 is open and there is something in the c_3] The bookcase contains [a list of things in the c_3].[end if]".
...
The bedroom part 9 is some text that varies. The bedroom part 9 is " plain door leading west.".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You scan the room, seeing a wall. [if there is something on the s_4]On the wall you make out [a list of things on the s_4].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_4]But the thing is empty. What's the point of an empty wall?[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading east.".
