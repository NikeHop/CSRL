...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see a shoe cabinet.[if c_3 is open and there is something in the c_3] The shoe cabinet contains [a list of things in the c_3].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Oh, great. Here's a bed. Wow, isn't TextWorld just the best? [if there is something on the s_1]On the bed you can see [a list of things on the s_1]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_1]However, the bed, like an empty bed, has nothing on it.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " Look out! It's a- oh, never mind, it's just a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_2]But the thing is empty, unfortunately.[end if]".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a kitchen. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh wow! Is that what I think it is? It is! It's a dining table. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_0]On the dining table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you see [a list of things on the s_3].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_3] Looks like someone's already been here and taken everything off it, though.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is " You scan the room, seeing a stove. [if there is something on the s_4]On the stove you make out [a list of things on the s_4].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the s_4]But the thing is empty. What's the point of an empty stove?[end if]".
