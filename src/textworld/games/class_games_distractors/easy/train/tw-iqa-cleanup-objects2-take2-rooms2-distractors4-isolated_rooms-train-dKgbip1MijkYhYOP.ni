...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You see a coat hanger. [if there is something on the s_4]You see [a list of things on the s_4] on the coat hanger.[end if]".
...
The bedroom part 8 is some text that varies. The bedroom part 8 is " You scan the room for a desk, and you find a desk. [if there is something on the s_5]On the desk you see [a list of things on the s_5].[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "[if there is nothing on the s_5]The desk appears to be empty.[end if]".
