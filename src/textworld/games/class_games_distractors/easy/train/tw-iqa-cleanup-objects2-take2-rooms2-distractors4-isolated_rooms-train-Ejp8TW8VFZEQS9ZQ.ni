...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a stove. The stove is conventional.[if there is something on the s_4] On the stove you can see [a list of things on the s_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_4] However, the stove, like an empty stove, has nothing on it. You move on, clearly depressed by TextWorld.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " What's that over there? It looks like it's a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can make out a wall. The wall is white.[if there is something on the s_6] On the wall you make out [a list of things on the s_6].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_6] The wall appears to be empty.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " plain door leading east.".
...
The printed name of s_6 is "wall".
Understand "wall" as s_6.
The s_6 is in r_1.
