...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell a wretched smell, and follow it to a shelf. The shelf is wooden.[if there is something on the s_3] On the shelf you can see [a list of things on the s_3].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a counter. You wonder idly who left that here. [if there is something on the s_4]You see [a list of things on the s_4] on the counter.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of trash. Hm. Oh well[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You rest your hand against a wall, but you miss the wall and fall onto a floor. [if there is something on the s_5]On the floor you can make out [a list of things on the s_5]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_5]However, the floor, like an empty floor, has nothing on it. It would have been so cool if there was stuff on the floor! oh well.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a bed. Wow, isn't TextWorld just the best? [if there is something on the s_1]On the bed you can see [a list of things on the s_1].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. Hm. Oh well[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " You rest your hand against a wall, but you miss the wall and fall onto a sofa. [if there is something on the s_2]You see [a list of things on the s_2] on the sofa. Wow! Just like in the movies![end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The o_1 and the o_4 and the o_0 and the o_2 and the o_3 and the o_5 are object-likes.
The o_1 and the o_4 and the o_0 and the o_2 and the o_3 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
...
The printed name of o_1 is "swimsuit".
Understand "swimsuit" as o_1.
...
The printed name of o_3 is "floor lamp".
Understand "floor lamp" as o_3.
Understand "floor" as o_3.
