...
The kitchen part 9 is some text that varies. The kitchen part 9 is " plain door leading south.".
...
The bedroom part 9 is some text that varies. The bedroom part 9 is " What's that over there? It looks like it's a TV stand. [if there is something on the s_5]You see [a list of things on the s_5] on the TV stand.[end if]".
...
The o_1 and the o_0 and the o_2 and the o_3 and the o_4 and the o_5 are object-likes.
The o_1 and the o_0 and the o_2 and the o_3 and the o_4 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
