...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a dining chair. The dining chair is solid.[if there is something on the s_4] On the dining chair you can see [a list of things on the s_4].[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " glass door leading south.".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You scan the room, seeing a chest of drawers.[if c_3 is open and there is something in the c_3] The chest of drawers contains [a list of things in the c_3].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_3 is open and the c_3 contains nothing] The chest of drawers is empty, what a horrible day![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " Look over there! a bed. The bed is large.[if there is something on the s_1] On the bed you see [a list of things on the s_1].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1] The bed appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " Oh, great. Here's a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you make out [a list of things on the s_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it.[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " You can make out a desk chair. [if there is something on the s_5]On the desk chair you see [a list of things on the s_5]. Hmmm... what else, what else?[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of garbage.[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 12 is some text that varies. The bedroom part 12 is " glass door leading north.".
...
The o_1 and the o_0 and the o_3 and the o_4 and the o_2 and the o_5 are object-likes.
The o_1 and the o_0 and the o_3 and the o_4 and the o_2 and the o_5 are privately-named.
The r_0 and the r_1 are rooms.
...
The printed name of o_1 is "jeans".
Understand "jeans" as o_1.
The o_1 is in r_1.
