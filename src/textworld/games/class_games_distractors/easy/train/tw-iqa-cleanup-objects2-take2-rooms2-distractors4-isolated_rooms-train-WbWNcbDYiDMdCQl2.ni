...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a coat hanger. [if there is something on the s_4]You see [a list of things on the s_4] on the coat hanger.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it.[end if]".
...
The printed name of o_5 is "corkscrew".
Understand "corkscrew" as o_5.
