...
The kitchen part 6 is some text that varies. The kitchen part 6 is " cutlery drawer nearby.[if c_3 is open and there is something in the c_3] The cutlery drawer contains [a list of things in the c_3]. Hmmm... what else, what else?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if c_3 is open and the c_3 contains nothing] The cutlery drawer is empty! What a waste of a day![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out an oven.[if c_4 is open and there is something in the c_4] The oven contains [a list of things in the c_4].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if c_4 is open and the c_4 contains nothing] The oven is empty, what a horrible day![end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " Hey, want to see a bed? Look over there, a bed. [if there is something on the s_1]You see [a list of things on the s_1] on the bed.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if there is nothing on the s_1]However, the bed, like an empty bed, has nothing on it.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a sofa. [if there is something on the s_2]On the sofa you can see [a list of things on the s_2].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_2]But there isn't a thing on it. What's the point of an empty sofa?[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is " You make out a desk. The desk is typical.[if there is something on the s_4] On the desk you see [a list of things on the s_4].[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_4] However, the desk, like an empty desk, has nothing on it.[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is " plain door leading south.".
...
The o_0 and the o_1 and the o_2 and the o_3 and the o_5 and the o_4 are object-likes.
The o_0 and the o_1 and the o_2 and the o_3 and the o_5 and the o_4 are privately-named.
The r_0 and the r_1 are rooms.
