...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Oh, great. Here's a dressing table. [if there is something on the s_5]On the dressing table you see [a list of things on the s_5].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_5]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is " plain door leading west.".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a kitchen cupboard.[if c_1 is open and there is something in the c_1] The kitchen cupboard contains [a list of things in the c_1]. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " Look out! It's a- oh, never mind, it's just a dining table. Wow, isn't TextWorld just the best? The dining table is massive.[if there is something on the s_0] On the dining table you see [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can see a sofa. Wow, isn't TextWorld just the best? The sofa is comfy.[if there is something on the s_2] On the sofa you can make out [a list of things on the s_2].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2] But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]However, the shelf, like an empty shelf, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " Look over there! a counter. The counter is vast.[if there is something on the s_4] On the counter you make out [a list of things on the s_4].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4] But the thing is empty. Hm. Oh well[end if]".
...
The printed name of o_5 is "pan".
...
The printed name of o_1 is "sugar".
Understand "sugar" as o_1.
