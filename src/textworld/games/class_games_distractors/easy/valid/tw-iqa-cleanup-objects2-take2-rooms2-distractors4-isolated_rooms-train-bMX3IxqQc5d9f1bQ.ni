...
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The kitchen cupboard is empty![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " oven.[if c_3 is open and there is something in the c_3] The oven contains [a list of things in the c_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if c_3 is open and the c_3 contains nothing] The oven is empty! This is the worst thing that could possibly happen, ever![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You bend down to tie your shoe. When you stand up, you notice a dining table. [if there is something on the s_0]You see [a list of things on the s_0] on the dining table. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. This always happens, here in TextWorld![end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You can make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you see [a list of things on the s_2]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_2] But there isn't a thing on it.[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is " Were you looking for a shelf? Because look over there, it's a shelf. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf.[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is "[if there is nothing on the s_3]Looks like someone's already been here and taken everything off it, though. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 15 is some text that varies. The kitchen part 15 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 16 is some text that varies. The kitchen part 16 is " glass door leading south.".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out a shoe cabinet.[if c_4 is open and there is something in the c_4] The shoe cabinet contains [a list of things in the c_4].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Oh, great. Here's a bed. The bed is large.[if there is something on the s_1] On the bed you can make out [a list of things on the s_1]. Huh, weird.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1] But the thing is empty, unfortunately. Hopefully this doesn't make you too upset.[end if]".
...
The printed name of c_3 is "oven".
Understand "oven" as c_3.
The c_3 is in r_0.
The c_3 is open.
The description of c_4 is "The [noun] looks towering. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to crack open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
The printed name of c_4 is "shoe cabinet".
Understand "shoe cabinet" as c_4.
Understand "shoe" as c_4.
...
The printed name of o_3 is "pot".
