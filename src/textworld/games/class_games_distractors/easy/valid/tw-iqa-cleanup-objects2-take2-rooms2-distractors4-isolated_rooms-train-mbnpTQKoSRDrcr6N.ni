...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can see a table. [if there is something on the s_5]You see [a list of things on the s_5] on the table.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_5]But the thing is empty. Hm. Oh well[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell a fine smell, and follow it to a dining table. You shudder, but continue examining the dining table. [if there is something on the s_0]On the dining table you can see [a list of things on the s_0].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of trash. Aw, and here you were, all excited for there to be things on it![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " Were you looking for a wall? Because look over there, it's a wall. The wall is white.[if there is something on the s_4] On the wall you can see [a list of things on the s_4].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4] Looks like someone's already been here and taken everything off it, though. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
