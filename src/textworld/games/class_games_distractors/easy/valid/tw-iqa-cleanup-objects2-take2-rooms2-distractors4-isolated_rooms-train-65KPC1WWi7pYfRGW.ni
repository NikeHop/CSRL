...
The bedroom part 7 is some text that varies. The bedroom part 7 is " glass door leading north.".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An ordinary one.
 ...
 Look over there! a fridge.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Hmmm... what else, what else?[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a dining table. The dining table is massive.[if there is something on the s_0] On the dining table you can make out [a list of things on the s_0].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0] However, the dining table, like an empty dining table, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a sofa. The sofa is comfy.[if there is something on the s_2] On the sofa you make out [a list of things on the s_2]. You shudder, but continue examining the room.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_2] But the thing is empty, unfortunately. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You can see a shelf. [if there is something on the s_3]You see [a list of things on the s_3] on the shelf.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of garbage.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is " You make out a wall. [if there is something on the s_4]On the wall you can make out [a list of things on the s_4].[end if]".
The kitchen part 12 is some text that varies. The kitchen part 12 is "[if there is nothing on the s_4]But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 13 is some text that varies. The kitchen part 13 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchen part 14 is some text that varies. The kitchen part 14 is " glass door leading south.".
