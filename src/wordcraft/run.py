...
def get_cmd_args():
    ...
    # Model settings (added model type abstraction)
    parser.add_argument("--arch", type=str, default="selfattn", choices=['abstraction'],
                        help="Type of agent.")
    ...
    # Addtional parameters for abstraction
    parser.add_argument('--n_abstractions', default=0, type=int,
                        help="Number of abstraction layers")
    parser.add_argument('--collapse', action='store_true',
                        help="Whether to collapse layers of the class tree")
    parser.add_argument('--start_level', type=int, default=15,
                        help="Starting layer for collapsing")
    parser.add_argument('--end_level', type=int, default=15, 
                        help="Final layer of collapsing")
    parser.add_argument('--priorKG_type', type=str, default='Wordnet', choices=['Wordnet'], 
                        help="Type of priorKG")
    parser.add_argument('--residual', action='store_true',
                        help="Whether to use the resiudal or sum algorithm")
...
if __name__ == '__main__':
    ...
    # # Download Spacy Resources for Glove embeddings
    # try:
